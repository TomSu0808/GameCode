...
class JointTab(object):
    ...
    def get_joint_orientation(*args):
...
class FK_Tab(object):
    ...
    def set_parent_controller_FK(*args):
...
class IK_Tab(object):
    ...
    def set_parent_controller_IK(*args):
...
class FK_IK_Switch(object):
    
    def select_original_joints(*args):
...
controllerWindow = cmds.window("Window", title = "Tom's AutoRig 3.0", sizeable=False, widthHeight=(340, 800))
