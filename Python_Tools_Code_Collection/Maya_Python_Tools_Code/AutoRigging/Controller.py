...
def CreateMaster():
    ## master
    master_ctrl = base.circle(nr = (0,1,0), c = (0,0,0), radius = 1, name = "MASTER_CONTROLLER")
...
def CreatePelvis():
    ## pelvis
    pelvis_ctrl = base.circle(nr = (0,1,0), c = (0,0,0), radius = 1.5, name = "CTRL_PELVIS")
    ...
    for side in sides:
        for i in range(0, fingerCount):
            ...
            for j in range(0,3):
                ...
                finger = base.curve(p =[(0,0,0), (0,0,0.5), (0.2, 0, 0.7),(0,0,0.9), (-0.2, 0, 0.7), (0,0,0.5)], degree = 10, name = "CTRL_"+side+"_Finger_"+str(i)+"_"+str(j))
