...
class generate_grp():
    ...
    ### card mesh windows
    def generate_mesh_grp_window(*args):
    ...
    def curve_to_card_mesh_grp(*args):
    ...
    def curve_to_card_mesh_single(*args):
        select_object = cmds.ls(selection=True)
    ...
    ### arc mesh windows
    def generate_arc_mesh_grp_window(*args):
    ...
    def curve_to_arc_mesh_grp(*args):
        select_object = cmds.ls(selection=True)
        ...
        if object_to_group:
            ...
            mesh_group = cmds.group(em = True, name="Mesh_Group")
            cmds.parent(object_to_group, "Mesh_Group")

    ### Generator single sweep Arc Mesh
    def curve_to_arc_mesh_single(*args):
        select_object = cmds.ls(selection=True)
